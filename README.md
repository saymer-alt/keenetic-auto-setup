...
- 256 МБ+ RAM — поддерживаемый/рекомендуемый профиль; 128 МБ-класс разрешён как best-effort/experimental без гарантии стабильности (installer предупредит; `disk` предпочтительнее `ram`)
