...
* **256+ MB RAM рекомендуется**; 128 MB-класс допускается только как best-effort/experimental без гарантии стабильности (установщик предупредит; на таком железе предпочтительнее `disk`)
