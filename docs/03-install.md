...
Скрипт перезапускает Mihomo и проверяет, что порт 7890 слушает (`netstat`/`ss`).
...
Если предупреждение «port 7890 not listening»:
