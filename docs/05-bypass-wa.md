...
Если хочешь дальше — логично идти в:

**06-s00ubifs.md** (там тоже есть нюансы, которые ты уже на практике прочувствовал — особенно про RAM и 128MB устройства)

И там можно прямо жёстко прописать:

> ❌ 128MB — не поддерживается (и почему)
